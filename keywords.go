...
// sourceOffset is a byte offset into the SQL source text being rewritten.
...
func writeToken(out *strings.Builder, text SQL, tok *pg_query.ScanToken, cursor sourceOffset) int {
